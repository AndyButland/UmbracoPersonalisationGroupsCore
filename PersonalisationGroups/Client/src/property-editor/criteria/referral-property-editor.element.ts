...
const elementName = "personalisation-group-referral-criteria-property-editor";

@customElement(elementName)
export class ReferralCriteriaPropertyUiElement extends UmbLitElement implements UmbPropertyEditorUiElement {
  ...
  @state()
  private _typedValue: ReferralSetting = { match: "MatchesValue", value: "" };
...
export default ReferralCriteriaPropertyUiElement;

declare global {
	interface HTMLElementTagNameMap {
		[elementName]: ReferralCriteriaPropertyUiElement;
	}
}

...
public class GeoLocationController : ControllerBase
{
    ...
    public GeoLocationController(IOptions<PersonalisationGroupsConfig> config, IHostEnvironment hostingEnvironment, AppCaches appCaches)
    {
    ...
    private Stream GetStreamForRegions()
    {
        ...
        {
            var mappedPath = _hostEnvironment.MapPathContentRoot(customFilePath);
